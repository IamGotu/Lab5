...
if(!empty($jsonObj->request_type) && $jsonObj->request_type == 'user_auth'){ 
    ...
    if(!empty($responsePayload)){ 
        ...
        if($result->num_rows > 0){  
            ...
            $query = "UPDATE users SET first_name = '".$first_name."', last_name = '".$last_name."', email
            = '".$email."', picture = '".$picture."', modified = NOW() WHERE oauth_provider = '".$oauth_provider."' AND oauth_uid = '".$oauth_uid."'"; 
