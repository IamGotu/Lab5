...
<!-- Main content -->
<section class="content text-justify col-sm-12">
    <div class="container-fluid">
        <div class="container-fluid">
            ...
            <form class="md-5">
                ...
                <p>This privacy policy will help you understand how the website uses and protects the data you provide to us when you visit and use the website.</p>
                ...
                <p>The website is committed to securing your data and keeping it confidential. The website has done all in its power to prevent data theft, unauthorized access, and disclosure by implementing the latest technologies and software, which help us safeguard all the information we collect online.</p>
                
                <h3>Links to Other Websites</h3>
                
                <p>Our website contains links that lead to other websites. If you click on these links the website is not held responsible for your data and privacy protection. Visiting those websites is not governed by this privacy policy agreement. Make sure to read the privacy policy documentation of the website you go to from our website.</p>
                ...
                <p>The website will not lease, sell or distribute your personal information to any third parties, unless we have your permission. We might do so if the law forces us. Your personal information will be used when we need to send you promotional materials if you agree to this privacy policy.</p>
                
                <p>Please read our <a href="Terms&Condition.php">Terms of Service</a></p>
